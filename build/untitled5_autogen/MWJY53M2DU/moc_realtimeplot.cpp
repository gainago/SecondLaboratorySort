...
#include <memory>
#include "../../../Tests/LoadTests/Ploat/Declaration/realtimeplot.h"
...
QT_MOC_LITERAL(4, 33, 8), // "testSize"
QT_MOC_LITERAL(5, 42, 10), // "timeBubble"
QT_MOC_LITERAL(6, 53, 9), // "timeQuick"
QT_MOC_LITERAL(7, 63, 11), // "timePiramid"
QT_MOC_LITERAL(8, 75, 9), // "timeShell"
QT_MOC_LITERAL(9, 85, 11) // "timeBitonic"

    },
    "RealTimePlot\0timeHandle\0\0setData\0"
    "testSize\0timeBubble\0timeQuick\0timePiramid\0"
    "timeShell\0timeBitonic"
};
...
void RealTimePlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setData((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4])),(*reinterpret_cast< double(*)>(_a[5])),(*reinterpret_cast< double(*)>(_a[6]))); break;
        default: ;
        }
    }
}
