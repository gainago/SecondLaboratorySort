...
void RealTimePlot::setData(double testSize, double timeBubble, double timeQuick, double timePiramid, double timeShell, double timeBitonic)
{
    
    x[counter] = testSize;
    Merge[counter] = timeBubble;
...
void RealTimePlot::timeHandle()
{
    ...
    QPointF newPointBubble = QPointF(this->x[this->lastAppend], this->Merge[this->lastAppend]);
    ...
    RealTimePlot::appendGraphPoint(newPointBubble, newPointQuick, newPointPiramid, newPointShell, newPointBitonic);
    ++lastAppend;
