...
void ShowPlotLoadTestsAllSorters()
{
    ...
    QLabel* labelTitle = new QLabel("ShowPlotFromFile. Bubble Sort: blue\t Merge Sort: magenta\t Quick Sort:red\t Piramid Sort:black\t\
    ...
    double x[102]; // 102 это количество различных размеров тестовых данных
    ...
    auto STD{ [](char inputStr[41] )->double // '0' = 48; '9' = 57 //здесь 41 просто так, не связано с Person
        {
            double d = 0;
            int coefficient;
